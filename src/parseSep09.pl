...
closedir(DIR);
print ("Found Files: ", join(',', @Export_files), "\n");
...
sub percent_above_threshold {
    ...
    $signalcount = 0;
    print ("End of percent_above_threshold ");
}
print ("---------------------------------------------\n");
...
foreach(@Export_files)
{
    ...
    print("INPUT_FILE_ALL $INPUT_FILE_ALL\n");
    ...
    print ("---------------------------------------------\n");
    print ("Theta90 Files: ", join(', ', @thea90_files), "\n");
    print ("---------------------------------------------\n");
    foreach(@theta90_files) {
        ...
        print("Displaying percent_above_threshold for $product_name\n");
    ...
    print ("\n");
    print ("---------------------------------------------\n");
    print ("Phi0 Files: ", join(', ', @phi0_files), "\n");
    print ("---------------------------------------------\n");
    foreach(@phi0_files) {
    ...
    print ("\n");
    print ("---------------------------------------------\n");
    print ("Phi90 Files: ", join(', ', @phi90_files), "\n");
    print ("---------------------------------------------\n");
    foreach(@phi90_files) {
        $INPUT_FILE = $_;
        print($folder_name2.$INPUT_FILE," ");
    ...
    print ("\n");
    print ("---------------------------------------------\n");
    print ("Efficiency Files: ", join(', ', @effic_files), "\n");
    print ("---------------------------------------------\n");
    foreach(@effic_files) {
        print("$_\n") unless -d;
